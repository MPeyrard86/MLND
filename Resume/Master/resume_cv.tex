...
\name{Matthew}{Peyrard}
\address{4424 Goldeneye Way, Ottawa, Ontario, Canada}
\mobile{(613) 794-8481}

\email{matt.peyrard@gmail.com}
\github{MPeyrard86}

\position{Software Engineer} % Your expertise/fields

\makecvfooter{\today}{Matthew Peyrard~~~·~~~Curriculum Vitae}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
